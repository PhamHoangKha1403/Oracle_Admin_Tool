...
BEGIN
    OPEN p_cursor FOR
        SELECT b.MA_BN, n.HO_TEN, n.PHAI, n.NGAY_SINH, n.CCCD, n.SDT, b.SO_NHA, b.TEN_DUONG, b.QUAN_HUYEN, b.TINH_TP, b.TIEN_SU_BENH, b.TIEN_SU_BENH_GD, b.DI_UNG_THUOC
        FROM BENH_NHAN b
...
AS
BEGIN
    INSERT INTO NHAN_VIEN (MA_NV, HO_TEN, PHAI, NGAY_SINH, CCCD, SDT, VAI_TRO)
    VALUES (p_MABN, p_HOTEN, p_PHAI, p_NGAYSINH, p_CCCD, p_SDT, 'Bệnh nhân');
